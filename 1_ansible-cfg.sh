...
echo "${red}Ansible${reset} uses a central configuration file to enable you to configure ${red}Ansible${reset} behaviors.  "
echo "This is where you configure things like - the location for your ${bold}private keys${reset}."
