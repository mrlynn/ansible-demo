  ...
  for instance in r.instances:
	...
	if instance.instance_type == 't2.small':
	  ...
	  if instance.instance_type == 't2.micro':
	    serverpool.append(instance.public_dns_name)

f = open('./ansible-hosts-serverpool', 'w')
f.write('[opsManager]\n')
...
f.write("\n")
f.write("[ServerPool]\n")
for machine in serverpool:
  f.write(machine + " ansible_user=ec2-user\n")
f.write("\n")
f.write("[ServerPool:vars]\n")
f.write("opsmanagerurl=http://" + opsmanager + ":8080\n")
f.write("opsmanager=" + opsmanager + "\n")
f.close()

print 'Written ./ansible-hosts-serverpool'
